...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.requirements.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('assigned_to_users[]', $assigned_to_users, old('assigned_to_users'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
                    <p class="help-block"></p>
